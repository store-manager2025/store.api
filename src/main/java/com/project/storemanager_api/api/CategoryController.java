...
public class CategoryController {
    ...
    // 생성
    @PostMapping
    public ResponseEntity<Map<String, Object>> saveCategory(@AuthenticationPrincipal CustomUserPrincipal principal,
                                                            @RequestBody SaveCategoryDto dto) {
    ...
    @StoreAuthCheck
    public ResponseEntity<List<CategoryResponseDto>> getAllCategories(@AuthenticationPrincipal CustomUserPrincipal principal,
