...
//    @StoreAuthCheck
    public ResponseEntity<Map<String, Object>> openStore(@PathVariable Long storeId) {
...
//    @StoreAuthCheck
    public ResponseEntity<Map<String, Object>> closeStore(@PathVariable Long storeId) {
